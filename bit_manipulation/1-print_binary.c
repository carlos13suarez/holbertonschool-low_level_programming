 ...
 * On the other hand, the for loop starts from the leftmost
 * bit of the n parameter, which is always 32, so that the
 * code starts looking for the first rightmost 1 bit, and
 * starts printing from right to left.
 *
 * Return: Nothing.
 */
